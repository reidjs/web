...
// function elizaBotReply(text){
// 	var thisBot = new ElizaBot(false);
// 	return thisBot.transform(text)
// 	// console.log(thisBot.transform(text));
// 	// console.log(thisBot.bot.transform(text));
// }
